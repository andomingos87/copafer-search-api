...
## Repository map
- `__pycache__/` — explain what lives here and when agents should edit it.
- `analyze_missing_skus.py/` — explain what lives here and when agents should edit it.
- `api.py/` — explain what lives here and when agents should edit it.
- `count_csv_rows.py/` — explain what lives here and when agents should edit it.
- `debug_pagination.py/` — explain what lives here and when agents should edit it.
- `debug_response_structure.py/` — explain what lives here and when agents should edit it.
